...
# chapter 6 -  rectified linear units and some l2 regularization (lmbda=0.1) and drop out => even better accuracy
...
net = Network([
    ...
    ConvPoolLayer(image_shape=(mini_batch_size, 20, 12, 12),
                  ...
                  poolsize=(2, 2),
                  activation_fn=ReLU),
    FullyConnectedLayer(n_in=40*4*4, n_out=1000, p_dropout=0.5, activation_fn=ReLU),
